...
class Cart {
    ...
    public function insert($item = array()){
        if(!is_array($item) OR count($item) === 0){
            ...
            if(!isset($item['name'], $item['descripcion'], $item['cantidad'],$item['precio'])){
                return FALSE;
            }else{
                /*
                 * Insert Item
                ...
                $old_qty = isset($this->cart_contents[$rowid]['
                
                tidad']) ? (int) $this->cart_contents[$rowid]['cantidad'] : 0;
        ...
        if (!is_array($item) OR count($item) === 0){
            ...
            if (!isset($item['rowid'], $this->cart_contents[$item['rowid']])){
               ...
               // if(isset($item['qty'])){
                ...
                // find updatable keys
                $keys = array_intersect(array_keys($this->cart_content[$item['rowid']], array_keys($item)));
                // prep the price
