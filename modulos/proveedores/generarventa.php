...
<script>
   ...
   function updateCartItem2(datos,id){
       $.get("funcionesphp/cartacompra.php", {action:"updateCartItem2", id:id, cantidad:datos.value}, function(data){
           alert('estoy aqui ');
           if(data == 'ok'){
              location.reload();
           }else{
...
<div class="content-modal">
   ...
   <form action="funcionesphp/cartacompra.php" method="post" id="formproducnuevo">
  
   <input type="hidden" name="" id="usr" value="<?php echo $ccusr ?>"> 
  
  <input type="hidden" name="id" id="id" value="0"> 
  <input type="text" name="name" id="name3" placeholder="Bien o servicio" class="input30" readonly="readonly">
  <input type="hidden" name="precio" id="precio3" placeholder="Precio" class="input30">
  <input type="hidden" name="cantidad" id="cantidad3" placeholder="Cantidad" class="input30">
  <input type="hidden" name="utilidad" id="utilidad3" placeholder="Porcentaje de utilidad" class="input30">
 ...
 <input type="hidden"  name="descripcion" id="descripcion3" placeholder="Descripcion" class="input100">
...
foreach($cartItems as $item){
  ...
  ?>
 <td> <a class="btn_eliminar " href="funcionesphp/cartacompra.php?action=removeCartItem&id=<?php echo $item["rowid"]; ?>" class="btn_eliminar"> Eliminar </a> </td>
  <?php
...
<a href="funcionesphp/cartacompra.php?action=guardar&vlr=<?php echo $valortotal; ?>" class="btn_guardar center">Generar Orden De Venta</a> 
...
<script src="js/ordenventa.js"></script>
</html>