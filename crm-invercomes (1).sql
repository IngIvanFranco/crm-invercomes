...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2022 a las 23:55:36
...
INSERT INTO `anticipos` (`id_anticipo`, `id_ordencompra`, `fecha_registro`, `valor`, `estado`, `forma_pago`) VALUES
(1, 2, '2022-01-31 05:22:27', 8000000, 'Generado', 'Consignacion'),
(2, 2, '2022-01-31 05:22:55', 9900000, 'Generado', 'Transferencia Bancaria');
...
INSERT INTO `clientes` (`id_cliente`, `nombre_cliente`, `nit_cliente`, `direccion_cliente`, `ciudad_cliente`, `telefono_cliente`, `correo_cliente`, `web_cliente`, `fecha_creacion`, `id_usr`, `contacto`) VALUES
(1, 'transportes @ ibague', 900242764, 'cra 54 n 49 120 sur', 'Ibagué-TOLIMA', '3123642008', 'isa-guz10@hotmail.com', 'taxisarroba.com', '2022-01-31 09:15:56', 1053811722, 'isabel guzman'),
(2, 'comfenalco', 900258476, 'cra 5 n 37-60 esquina', 'Ibagué-TOLIMA', '2666999', 'cristian@comfenalco.com.co', 'comfenalco.com.gov', '2022-01-31 09:18:29', 1053811722, 'crsitian vera'),
(3, 'seapto', 900258413, 'Calle 10 No 3-56', 'Ibagué-TOLIMA', '3125874596', 'comercial2@invercomes.com.co', 'invercomes.com.co', '2022-01-31 09:21:14', 1053811722, 'juan carlos bermeo'),
(4, 'invercomes sas', 803854789, 'calle 10a n 3-56', 'Ibagué-TOLIMA', '2703045', 'criss.ramirez@ganagana.com.co', 'invercomes.com.co', '2022-01-31 09:27:44', 1053811722, 'criss ramirez'),
(5, 'net grid', 802587458, 'cra 5 n 23-65', 'Bogotá D.C.-BOGOTÁ, D.C.', '3124569873', 'proyectos@netgrid.com', 'netgrid.com.co', '2022-01-31 09:32:04', 1053811722, 'tatiana muñoz'),
(6, 'samid', 803812017, 'cc comercial la 5 local 206', 'Ibagué-TOLIMA', '322245879', 'hejagalo@hotmail.com', 'samidsa.com', '2022-01-31 09:37:28', 1053811722, 'hernan galevez'),
(7, 'club deportes tolima', 902569874, 'barrio cadiz calle 35-4b5', 'Ibagué-TOLIMA', '3123645874', 'gabigol@homtial.com', 'deportestolima.com.co', '2022-01-31 09:41:13', 1053811722, 'gabriel camargo'),
(8, 'comfatolima', 6786768, 'avenida ambala con calle 69 esquina', 'Ibagué-TOLIMA', '3126987458', 'jose.cruz@comfatolima.com', 'comfatolima', '2022-02-02 03:11:23', 1053811722, 'jose cruz'),
(9, 'comfamiliares', 805748963, 'avenida paralela calle 50 esquina', 'Manizales-CALDAS', '3133578596', 'acosta.johana@comfamiliares.com.co', 'comfamiliares.com.co', '2022-02-02 04:02:28', 1053811722, 'marcela salazar');
...
CREATE TABLE `detalle_ordencompra` (
  ...
  `valor` int(11) NOT NULL,
  `utilidad` int(11) NOT NULL DEFAULT 8
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `detalle_ordencompra` (`id_detalleorden`, `id_ordencompra`, `producto_id`, `cantidad`, `valor`, `utilidad`) VALUES
(1, 1, 1, 2, 2500000, 10),
(2, 2, 2, 2, 98000000, 10),
(3, 2, 3, 3, 45000000, 8);
...
CREATE TABLE `ordenesdecompra` (
  `id_ordenescompra` int(11) NOT NULL,
  `valor_total` int(11) NOT NULL,
  `fecha_registro` datetime NOT NULL,
  `status` int(11) NOT NULL,
  `id_usradmin` int(11) NOT NULL,
...
INSERT INTO `ordenesdecompra` (`id_ordenescompra`, `valor_total`, `fecha_registro`, `status`, `id_usradmin`, `id_proveedor`) VALUES
(1, 5000000, '2022-02-02 14:46:22', 1, 1053811722, 1),
(2, 331000000, '2022-02-02 14:48:20', 1, 1053811722, 1);
...
CREATE TABLE `productos` (
  ...
  `descripcion_producto` varchar(1800) NOT NULL,
...
INSERT INTO `productos` (`id_producto`, `nombre_producto`, `descripcion_producto`, `stok`, `valor`, `codigo_proveedor`, `numerodeparte`, `utilidad`, `id_usr`) VALUES
(1, 'comutador', 'computador todo en 1 con muchas pendejadas', 2, 2500000, '26554715', 'sdahg55646', 10, 1053811722),
(2, 'bmw', 'z4 convertible cabirolet 2.0 turbo', 2, 98000000, 'adf46as', '56sa4', 10, 1053811722),
(3, 'motocicleta', 'kawasaki zx 6r', 3, 45000000, 'sd456sad5', 'sfaff543', 8, 1053811722);
...
CREATE TABLE `proveedores` (
  ...
  `tipodistribucion` varchar(200) NOT NULL,
  `observaciones` varchar(1800) NOT NULL,
  `asesor` varchar(200) NOT NULL,
  `creacion` datetime NOT NULL,
  `id_usradmin` int(11) NOT NULL,
  `direccion` varchar(1800) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `proveedores` (`id_proveedor`, `nombre_proveedor`, `nit_proveedor`, `Correo_proveedor`, `web_proveedor`, `telefono_proveedor`, `ciudad`, `linea`, `productos`, `tipodistribucion`, `observaciones`, `asesor`, `creacion`, `id_usradmin`, `direccion`) VALUES
(1, 'tecnologicos sumapaz', 900242764, 'correodemotos@gmail.com', 'tecnologicos.com.co', '3124101773', 'Bogotá D.C.-BOGOTÁ, D.C.', 'tecnologia', 'computadores todo en uno televisores celulares y mucho mas', 'Directa', 'empresa dedicada a la comercializacion de tecnologia', 'cristian vaquiro', '2022-01-31 04:41:40', 1053811722, 'Calle 50A No 10-06');
...
INSERT INTO `usr_admin` (`id_usr`, `identificacion`, `nombre`, `pass`, `id_tipo_usr`, `estado`) VALUES
(1, 1053811722, 'IVAN DARIO FRANCO NOVOA', '3627909A29C31381A071EC27F7C9CA97726182AED29A7DDD2E54353322CFB30ABB9E3A6DF2AC2C20FE23436311D678564D0C8D305930575F60E2D3D048184D79', 1, 1);
...
CREATE TABLE `visitas` (
  ...
  `tipovisita` varchar(200) NOT NULL,
  `id_proveedor` int(11) NOT NULL,
  `lugar` varchar(1800) NOT NULL,
  `observacion` varchar(1800) NOT NULL,
  `id_usr` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `visitas` (`id_visita`, `fecha_visita`, `hora_visita`, `tipovisita`, `id_proveedor`, `lugar`, `observacion`, `id_usr`) VALUES
(1, '2022-02-01', '11:33:00', 'Seguiminento', 1, 'cc aqua en juan valdez ', 'visita para mostrar y cerrar negocio con los productos nuevos', 1053811722);
...
ALTER TABLE `ordenesdecompra`
  ADD PRIMARY KEY (`id_ordenescompra`);
...
--
ALTER TABLE `anticipos`
  MODIFY `id_anticipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detalle_ordencompra`
  MODIFY `id_detalleorden` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ordenesdecompra`
  MODIFY `id_ordenescompra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
